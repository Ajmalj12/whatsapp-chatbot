...
const HOSPITAL_DEPARTMENT_ICONS = [
    '❤️', '🫀', '🧠', '🫁', '🦴', '👶', '🧴', '🩺',
    '👁️', '👂', '🦷', '🏥', '💉', '🩹', '🧪', '🧬',
    '🩻', '🚑', '🧑‍⚕️', '👨‍⚕️', '👩‍⚕️', '🫂', '🩸', '⚕️'
];
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-2 bg-slate-100 text-slate-700 border border-slate-200 rounded-xl text-sm font-semibold hover:bg-slate-200 transition-all"
                                            title="Select from hospital icons"
                                        >
                                            Pick
                                        </button>
                                    </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
                    <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-5 shadow-xl">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-base font-bold text-slate-900">Select Department Icon</h3>
                            <button
                                type="button"
                        ...
                        <p className="text-xs text-slate-500 mb-3">Choose a hospital-related icon for this department.</p>
                        <div className="grid grid-cols-8 gap-2">
                            {HOSPITAL_DEPARTMENT_ICONS.map((icon) => (
                                <button
                                    key={icon}
                                    type="button"
                                    onClick={() => {
                                    ...
                                    className="h-10 w-10 rounded-lg border border-slate-200 text-xl hover:bg-emerald-50 hover:border-emerald-200 transition-all"
                                    title={`Use ${icon}`}
                                >
                                    {icon}
                                </button>
